...
public class TeamStatsPanel extends ContentPanel{
	...
	private TableData[] getTeamDataAll(ArrayList<TeamDataPO> po){
		...
		for(int i=0;i<po.size();i++){
			String[] row = {String.valueOf(i+1),po.get(i).getName(),String.valueOf(po.get(i).getMatchNumber()),String.valueOf(po.get(i).getShootEffNumber()),String.valueOf(po.get(i).getShootNumber()),
	...
	private TableData[] getTeamDataAvg(ArrayList<TeamDataPO> po){
		...
		TableData[] data = new TableData[po.size()];
		for(int i=0;i<po.size();i++){
			String[] row = {String.valueOf(i+1),po.get(i).getName(),String.valueOf(po.get(i).getMatchNumber()),String.valueOf(po.get(i).getShootEffNumberPG()),String.valueOf(po.get(i).getShootNumberPG()),
